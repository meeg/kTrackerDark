...
public:
    ...
    {
        return (Double_t)getNHits() - 0.4*getChisq();
    }
    ...
    Double_t getMomentumSt1(Double_t& px, Double_t& py, Double_t& pz)
    {
        return getMomentum(fState.front(), px, py, pz);
    }
    Double_t getMomentumSt1()
    {
        Double_t px, py, pz;
        return getMomentumSt1(px, py, pz);
    }
    TVector3 getMomentumVecSt1()
    {
        Double_t px, py, pz;
        getMomentumSt1(px, py, pz);
        return TVector3(px, py, pz);
    }

    Double_t getMomentumSt3(Double_t& px, Double_t& py, Double_t& pz)
    {
        return getMomentum(fState.back(), px, py, pz);
    }
    Double_t getMomentumSt3()
    {
        Double_t px, py, pz;
        return getMomentumSt3(px, py, pz);
    }
    TVector3 getMomentumVecSt3()
    {
        Double_t px, py, pz;
        getMomentumSt1(px, py, pz);
        return TVector3(px, py, pz);
    ...
    Double_t getPositionSt1(Double_t& x, Double_t& y)
    {
        return getPosition(fState.front(), x, y);
    }
    Double_t getPositionSt1()
    {
        Double_t x, y;
        return getPositionSt1(x, y);
    }
    TVector3 getPositionVecSt1()
    {
        Double_t x, y;
        getPositionSt1(x, y);
        return TVector3(x, y, fZ.front());
    }

    Double_t getPositionSt3(Double_t& x, Double_t& y)
    {
        return getPosition(fState.back(), x, y);
    }
    Double_t getPositionSt3()
    {
        Double_t x, y;
        return getPositionSt3(x, y);
    }
    TVector3 getPositionVecSt3()
    {
        Double_t x, y;
        getPositionSt3(x, y);
        return TVector3(x, y, fZ.back());
    }
    ...
    {
        return fKalmanStatus > 0;
    }
    void setKalmanStatus(Int_t status)
    {
        fKalmanStatus = status;
    }
    ...
    {
        return getMomentum(fStateVertex, px, py, pz);
    }
    Double_t getZVertex()
    {
        return fVertexPos[2];
    ...
    {
        return fState.back()[1][0] - fPropSlopeX;
    }
    Double_t getDeflectionY()
    {
        return fState.back()[2][0] - fPropSlopeY;
    }
    Int_t getNHitsInPTX()
    {
        return fNPropHitsX;
...
public:
    ...
    {
        return fLocalID[hitID];
    }

    ///Get tracks
    Int_t getNTracks()
    {
        return fAllTracks.size();
    }
    ...
    {
        fAllTracks.push_back(trk);
    }
    void reIndex()
    {
        sort(fAllTracks.begin(), fAllTracks.end());
    }

    ///Insert dimuon
    void insertDimuon(SRecDimuon dimuon)
    {
        fDimuons.push_back(dimuon);
    }
