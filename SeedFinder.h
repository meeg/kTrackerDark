...
#include "SRawEvent.h" //needed because we hold vector<Hit> instead of vector<Hit*>

//forwards
//class SRawEvent; should only to be forward
class Hit;
class GeomSvc;
...
class SeedFinder
{
  ...
  private:
    SRawEvent *event;
    std::vector<Hit> hitAll; //todo: vector of Hit*
