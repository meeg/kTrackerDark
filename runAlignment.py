...
for i in range(offset, nCycle+1):
    ...
    runCmd('./hodoAlign rec_align_'_str(i)+'.root hodoAlign_temp.root alignment_hodo_'+str(i)+'.txt > log_hodo_'+str(i))
    runCmd('./propAlign rec_align_'_str(i)+'.root propAlign_temp.root alignment_prop_'+str(i)+'.txt > log_prop_'+str(i))
